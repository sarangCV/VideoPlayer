import {View, Text, TouchableOpacity, Touchable, Image, Alert} from 'react-native';
        ...
        {clicked && (
          <TouchableOpacity
            ...
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity
                onPress={() => {
                  ref.current.seek(parseInt(progress && progress.currentTime) - 10);
                }}>
                <Image
            ...
            <View
              ...
              <Text style={{color: 'white'}}>
                {format(progress&&progress.currentTime)}
              </Text>
              <Slider
              ...
              />
              <Text style={{color: 'white'}}>
                {format(progress&&progress.seekableDuration)}
              </Text>
            </View>
            <View
              style={{
